    ...
    >
      ...
      <div className="flex items-center gap-1">
        ...
        {user ? (
          <>
            ...
            <div className="flex items-center gap-1.5 ml-1 cursor-pointer group px-2.5 py-1.5 rounded-md hover:bg-slate-100 dark:hover:bg-[#21262D] transition-colors">
              ...
              <div className="hidden md:flex flex-col leading-none">
                <span className="text-xs font-semibold text-slate-900 dark:text-[#E6EDF3]">{user.username}</span>
                <span className="text-[10px] text-slate-500 dark:text-[#8B949E]">Demo Account</span>
              </div>
          ...
          <div className="text-xs text-slate-500 dark:text-[#8B949E] font-medium px-2">AWS Route 53</div>
        )}
      </div>
    </header>
  );
