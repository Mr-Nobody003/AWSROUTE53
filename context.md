...
- **Styling**: Tailwind CSS is heavily utilized to accurately replicate the dense, functional aesthetic of the AWS console.
- **Form Modals**: DNS Record creation mimics the AWS slide-over panel on the right side rather than a centered modal dialog.
